...
%That is, $\bigcup_{i=1}^d E(G_i) = E(G)$ (hence, if $G$ is not a multigraph, then the $G_i$ are pairwise edge-disjoint).
...
%That is, $\bigcup_{i=1}^d E(K_i) = E(K)$, where this union respects multiplicity (hence, if $K$ is not a multihypergraph, then the blocks are pairwise edge-disjoint).
