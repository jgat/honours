...
\begin{theorem}[\cite{verall}] \label{berge-hamilton}
...
\begin{theorem}[\cite{kuhn-osthus}] \label{berge-hamilton2}
...
\begin{conjecture}[\cite{bail-stev}] \label{bailey-stevens}
